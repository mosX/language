...
class mainframe {
    ...
    function run() {
        ...
        $this->questions = array(
            1=>_("My favorite sports club?"),
            2=>_("My favorite hobby?"),
            3=>_("Pet's name?"),
            4=>_("First car Brand?"),
            5=>_("My secret code?")
        );
    ...
    switch($this->_lang){
            case 'pt': $this->addCSS('fix_pt');break;
            case 'ar': $this->addCSS('fix_ar');break;
            case 'es': $this->addCSS('fix_es');break;
        }
    ...
    public function getUniqueVisitor(){        
        ...
        $this->_user->uid_id = $this->activity->visitorID;
        $this->_user->uid = $this->activity->visitorUID;
    }    
